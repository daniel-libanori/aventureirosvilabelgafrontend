      ...
      <Card h="100%">
        <Flex p={20} align="center" justify="space-between" direction="column">
          ...
          <Input
            type="number"
            min="1"
            placeholder="Numero Linhas"
            value={linhasMap}
            onChange={(e) => {
              setLinhasMap(e.target.value);
            }}
          />
          ...
          <Input
            type="number"
            min="1"
            placeholder="Numero Colunas"
            value={colunasMap}
            onChange={(e) => {
              setColunasMap(e.target.value);
            }}
          />

          <Button
            isDisabled={
              !imageBase64 || mapName == "" || linhasMap < 1 || colunasMap < 1
            }
            style={{ marginTop: 10 }}
            onClick={addNewMap}
          >
