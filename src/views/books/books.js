...
export function Books() {
  ...
  const [updateOrAddBookModalType, setUpdateOrAddExpPointModalType] =
              ...
              <Flex direction="column" overflowY="auto" maxHeight={265}>
                {books.length > 0 ? (
                  books.map((book, idx) => (
                    <Flex
                      key={book.id}
                      onClick={() => navigate(`/${book.id}/chapters`)}
                      minW={400}
                        ...
                        <Flex direction={"column"} justify={"space-evenly"}>
                          <Icon
                            ...
                            onClick={(event) => {
                              ...
                              handleSelectBookToOpenUpdateModal(book);
                            }}
                          />
                          <Icon
                            as={BsTrash3Fill}
                  ...
                  <Flex align="center" justify="center" w={"100%"} h={100}>
                    <Text fontSize="xl" textAlign="center">
                      Você ainda não possui livros criados
                    </Text>
                  </Flex>
                )}
              </Flex>
